...
import com.example.tracking_app.utils.GeoLocationServiceUtils
...
class ForegroundOnlyLocationService : Service() {
            ...
            override fun onLocationResult(locationResult: LocationResult) {
                ...
                if(currentLocation != null){
                    GlobalScope.launch (Dispatchers.Main) {
                        LocationRepository.getInstance(applicationContext).addLocation(locationResult.toLocationEntity())
                    }
                }
                ...
                println("Current Coordinates  "+currentLocation?.latitude + "    "+currentLocation?.altitude +"   "+currentLocation?.longitude +"    "+currentLocation?.provider +"   "+currentLocation?.accuracy+"   "+currentLocation?.time +"   "+currentLocation?.speed + "  "+currentLocation?.speedAccuracyMetersPerSecond+"   "+currentLocation?.extras)
    ...
    override fun onUnbind(intent: Intent): Boolean {
        ...
        // we do nothing.
        if (!configurationChange && GeoLocationServiceUtils.getLocationTrackingPref(this)) {
    ...
    fun subscribeToLocationUpdates() {
        ...
        GeoLocationServiceUtils.saveLocationTrackingPref(this, true)
        ...
        try {
            ...
            GeoLocationServiceUtils.saveLocationTrackingPref(this, false)
    ...
    private fun generateNotification(location: Location?): Notification {
        Log.d(TAG, "generateNotification()"+ location?.latitude + "   "+location?.longitude)
        ...
        return notificationCompatBuilder
                ...
                .addAction(
                        R.drawable.ic_launch_foreground, getString(R.string.launch_activity),
                        activityPendingIntent
                )
                .addAction(
                        R.drawable.ic_cancel_foreground,
